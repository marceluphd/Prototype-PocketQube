...
/*
******************************************************************************************************
  Values for return errors in LoRa TX and RX routines
******************************************************************************************************
*/

const uint8_t RXbuffersize = 1;
const uint8_t TXSbuffersize = 1;
const uint8_t TXtimeout = 2;

/*
******************************************************************************************************
  Values used for applications with GPS
******************************************************************************************************
*/
...
const unsigned int addr_EndBindData = 0x17;                   //marks the end of the Bind data
/*********************************************************************
  END bind data
**********************************************************************/
